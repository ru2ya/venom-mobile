...
export const wilayas = [
  { code: '01', name: 'Adrar', fee: 1200 },
  { code: '09', name: 'Blida', fee: 500 },
  { code: '16', name: 'Alger', fee: 400 },
  { code: '25', name: 'Constantine', fee: 700 },
  { code: '31', name: 'Oran', fee: 700 },
  { code: '06', name: 'Béjaïa', fee: 650 },
  { code: '05', name: 'Batna', fee: 750 },
  { code: '23', name: 'Annaba', fee: 800 },
  { code: '19', name: 'Sétif', fee: 650 },
  { code: '30', name: 'Ouargla', fee: 1000 },
]
